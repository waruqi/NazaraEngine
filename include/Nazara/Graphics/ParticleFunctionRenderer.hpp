...
namespace Nz
{
	...
	using ParticleFunctionRendererConstRef = std::shared_ptr<const ParticleFunctionRenderer>;
	using ParticleFunctionRendererRef = std::shared_ptr<ParticleFunctionRenderer>;
